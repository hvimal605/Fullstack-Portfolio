        ...
        {softwareApplications && softwareApplications.length > 0 ? (
          softwareApplications.map((element) => (
            <tr key={element._id} className="bg-accent">
              ...
              <td className="px-2 sm:px-6 py-4 whitespace-nowrap text-center text-sm font-medium justify-end">
          ...
          <tr>
            <td
              colSpan={3}
              className="px-2 sm:px-6 py-4 whitespace-nowrap text-3xl text-gray-500"
            >
